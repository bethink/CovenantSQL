...
cd ${PROJECT_DIR} && find ./test/service_split/node_miner_0 -type d -name 'data' -exec rm -vrf {} \;
cd ${PROJECT_DIR} && find ./test/service_split/node_miner_1 -type d -name 'data' -exec rm -vrf {} \;
cd ${PROJECT_DIR} && find ./test/service_split/node_miner_2 -type d -name 'data' -exec rm -vrf {} \;
